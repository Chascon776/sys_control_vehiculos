...
class Automovil(Vehiculos):
    ...
    def __str__(self):
        ...
        mensaje = f"Datos del automóvil  Marca {self.marca}, Modelo {self.modelo}, {self.num_ruedas} Ruedas, {self.velocidad} Km/h ,{self.cilindrada} cc"
        return mensaje
...
class Bicicleta(Vehiculos):
    ...
    def __str__(self):
        """imprime la clase padre + hijo"""
        mensaje = f"Datos de la bicicleta  : Marca {self.marca}, Modelo {self.modelo}, {self.num_ruedas} Ruedas,tipo {self.tipo_bici} "
        return mensaje
...
class Carga(Automovil):
    ...
    def __str__(self):
        """imprime la clase padre + hijo"""
        mensaje = f"Datos del automóvil de carga  : Marca {self.marca}, Modelo {self.modelo}, {self.num_ruedas} Ruedas, {self.velocidad} Km/h ,{self.cilindrada} cc, Carga : {self.carga} Kg "
        return mensaje
...
class Particular(Automovil):
    ...
    def __str__(self):
        """imprime la clase padre + hijo"""
        mensaje = f"Datos del automóvil particular  : Marca {self.marca}, Modelo {self.modelo}, {self.num_ruedas} Ruedas, {self.velocidad} Km/h ,{self.cilindrada} cc, Nro Puestos : {self.nro_puestos}"
        return mensaje
...
class Motocicleta(Bicicleta):
    ...
    def __str__(self):
        mensaje = f"Datos de la motocicleta : Marca {self.marca}, Modelo {self.modelo}, {self.num_ruedas} Ruedas, nro radios : {self.nro_radios}, Cuadro : {self.cuadro}, motor : {self.motor}"
        return mensaje
